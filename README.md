...
**Функции входа нет.** Нет ввода номера, кода подтверждения и сессии, нет подключения
к Telegram. Приложение это показывает; список чатов не открывается.

| Что показывает приложение сейчас | Как список выглядит при заполнении |
| :---: | :---: |
| <img src="docs/images/sign-in.png" width="220" alt="Нет функции входа"> | <img src="docs/images/chat-list.png" width="220" alt="Макет оформления списка чатов"> |
...
| 2. Прототип: запуск, авторизация, список чатов, текст | функции входа нет; отрисовка списка готова, протокол не начат |
