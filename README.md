...
**Сессии нет.** Ни авторизации, ни подключения к Telegram, ни сообщений в приложении
не существует. Экран входа об этом прямо говорит; список чатов не показывается,
потому что без входа его не из чего заполнить.

| Что показывает приложение сейчас | Как список выглядит при заполнении |
| :---: | :---: |
| <img src="docs/images/sign-in.png" width="220" alt="Экран входа"> | <img src="docs/images/chat-list.png" width="220" alt="Макет оформления списка чатов"> |
...
| 2. Прототип: запуск, авторизация, список чатов, текст | экран входа честно говорит, что авторизации нет; отрисовка списка готова, протокол не начат |
...
tools\preview-ui.ps1 -Empty  REM отрисовывает текущий экран входа
